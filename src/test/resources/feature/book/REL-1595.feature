@ST_14883 @tagtagtag @this_is_story_tag
...
@SC_62527 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_62528 @third_scenario_tag
...
@SC_62529 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_62530 @fifth_scenario_tag
