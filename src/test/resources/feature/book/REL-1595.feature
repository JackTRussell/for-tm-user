@ST_41055 @tagtagtag @this_is_story_tag
...
@SC_155598 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_155599 @third_scenario_tag
...
@SC_155600 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_155601 @fifth_scenario_tag
