@ST_14769 @tagtagtag @this_is_story_tag
...
@SC_61881 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_61882 @third_scenario_tag
...
@SC_61883 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_61884 @fifth_scenario_tag
