@ST_191782 @tagtagtag @this_is_story_tag
...
@SC_418866 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_418867 @third_scenario_tag
...
@SC_418868 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_418869 @fifth_scenario_tag
