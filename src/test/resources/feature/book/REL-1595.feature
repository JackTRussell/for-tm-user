@ST_61156 @tagtagtag @this_is_story_tag
...
@SC_175737 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_175738 @third_scenario_tag
...
@SC_175739 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_175740 @fifth_scenario_tag
